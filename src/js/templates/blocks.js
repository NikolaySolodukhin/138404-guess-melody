...
const getMistakeTemplate = mistakeNumbers => `<div class="main-mistakes">
             ${new Array(mistakeNumbers)
               .fill(
...
const getPlayerWrapperTemplate = (
  questionType,
  songSrc
) => `<div class="player-wrapper">
             <div class="player">
               <audio src="${songSrc}" ${
  questionType === QuestionTypes.QUESTION_ARTIST ? `autoplay` : ``
} loop></audio>
               <button class="player-control ${
                 questionType === QuestionTypes.QUESTION_ARTIST
